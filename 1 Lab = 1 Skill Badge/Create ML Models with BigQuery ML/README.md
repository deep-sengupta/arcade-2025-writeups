...
- Open BigQuery
- Create a dataset with the dataset ID
- Run the script (Task 1)
...
## Improve model performance with Feature Engineering and Evaluate the model to see if there is better predictive power
- Run this script in BigQuery Editor
```sql
...
- Run the script (Task 4)
- Now run this script in BigQuery Editor
```sql
SELECT
*
FROM
